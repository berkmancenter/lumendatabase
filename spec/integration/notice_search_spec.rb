...
feature 'Searching Notices', type: :feature do
  ...
  scenario 'includes facets', js: true do
    ...
    # is changed.
    find('a.language_facet').click
    expect(page).to have_css('ol.language_facet li', count: 2)
    find('a.tag_list_facet').click
  ...
  scenario 'cache does not break date filter', cache: true, js: true do
    ...
    find('a.date_received_facet').click
    expect(
