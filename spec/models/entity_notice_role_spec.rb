...
describe EntityNoticeRole, type: :model do
  ...
  context '#entities' do
    ...
    it "does not use existing entities when entity_notice_role uses also existing entity when redacting using Lumen::Redactors::GoogleSenderRedactor" do
      ...
      Lumen::Redactors::GoogleSenderRedactor.new.redact(notice)
