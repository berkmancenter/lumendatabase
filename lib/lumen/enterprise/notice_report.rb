class Lumen::Enterprise::NoticeReport
  ...
  def self.recent(enterprise_account, limit: 5)
    Notice
      ...
      .limit(500)
      .select { |notice| Lumen::Enterprise::NoticeAccess.for_account(enterprise_account, notice).allowed? }
      .first(limit)
  end
  ...
  def notices
    @notices ||= begin
      ...
      scope.select do |notice|
        Lumen::Enterprise::NoticeAccess.for_account(enterprise_account, notice).allowed?
      end
    end
  end
  ...
  def notice_json(notice)
    access = Lumen::Enterprise::NoticeAccess.for_account(enterprise_account, notice)
