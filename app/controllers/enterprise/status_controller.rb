...
class Enterprise::StatusController < ApplicationController
  ...
  def show
    return redirect_to(enterprise_root_path) if current_user.active_enterprise_account
    return redirect_to(enterprise_account_path) if current_user.confirmed_enterprise_user?
